...
class PurgeOldDataDatabaseTest extends MaintenanceBaseTestCase {
	...
	public function testExecute( $config, $shouldPurgeRecentChanges ) {
		...
		// The expected cutoff is generated by the fixed timestamp in ::setUp
		$expectedCutoff = $this->getDb()->timestamp( '20230405060638' );
		...
		// Mock the CheckUserCentralIndexManager service to expect a call.
		...
		$mockCheckUserCentralIndexManager->expects( $this->exactly( 2 ) )
			...
			->with( $expectedCutoff, $this->getDb()->getDomainID() )
