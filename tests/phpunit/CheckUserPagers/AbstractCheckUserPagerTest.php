 ...
 * @group Database
 *
 * @covers \MediaWiki\CheckUser\CheckUserPagers\AbstractCheckUserPager
 */
class AbstractCheckUserPagerTest extends MediaWikiIntegrationTestCase {
	...
	/**
	 * @covers \MediaWiki\CheckUser\CheckUserPagers\AbstractCheckUserPager::getIpConds
	...
	/**
	 * @covers \MediaWiki\CheckUser\CheckUserPagers\AbstractCheckUserPager::userWasBlocked
