...
Use this in accordance with policy.',
	...
	'checkuser-massblock-text'   => 'Selected accounts will be blocked indefinetly, with autoblocing enabled and account creation disabled. 
...
$messages['de'] = array(
	...
	'checkuser-wasblocked' => 'Vorhergehende Sperren',
...
לא יוחזרו יותר מ־5000 עריכות מסיבות של עומס על השרתים. אנא השתמשו בכלי זה בהתאם למדיניות.',
	...
	'checkuser-email-action2' => 'שלח דואר אלקטרוני למשתמש "$1" (נשלח מהכתובת "$2")',
);
