...
នេះគឺ IP ដែលបានប្រើប្រាស់ (អតិបរមា ៥០០០, រៀបតាម​អាសយដ្ឋាន)​៖',
	...
	'checkuser-log-return' => 'ត្រឡប់ទៅកាន់បែបបទដើមនៃការត្រួតពិនិត្យអ្នកប្រើប្រាស់', # Fuzzy
...
다음은 사용되고 있는 IP의 목록입니다 (최대 5000개, 주소별로 정렬됨):',
	...
	'checkuser-autocreate-action' => '계정이 자동으로 만들어졌습니다.',
	'checkuser-create-action' => '만들어졌습니다',
	'checkuser-email-action' => '"$1" 사용자에게 이메일을 보냄',
	'checkuser-reset-action' => '"$1" 사용자의 비밀번호를 바꿈',
